...
```{r, echo=FALSE, fig.cap="Daisy-Workflow", fig.align = 'center', out.width='110%'}
...
```{r, echo=FALSE, fig.cap="Milestones of our project", fig.align = 'center', out.width='110%'}
...
# Create data frame with expression and CNA values
