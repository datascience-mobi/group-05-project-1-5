...
```{r image1, echo=FALSE, fig.cap="Most affected tissues and organs by head and neck cancer", fig.align = 'center', out.width='100%'}
...
\newpage
```{r image2, echo=FALSE, fig.cap="Daisy-Workflow", fig.align = 'center', out.width='100%'}
...
\newpage
## Milestones
```{r image3, echo=FALSE, fig.cap="Milestones of our project", fig.align = 'center', out.width='100%'}
