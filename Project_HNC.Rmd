...
```{r, echo=FALSE, fig.cap="Most affected tissues and organs by head and neck cancer", fig.align = 'center', out.width='100%'}
...
\newpage
```{r, echo=FALSE, fig.cap="Daisy-Workflow", fig.align = 'center', out.width='100%'}
...
\newpage
## Milestones
```{r, echo=FALSE, fig.cap="Milestones of our project", fig.align = 'center', out.width='100%'}
...
ID_HNC_highest_frequencies = head(order(HNC_mut_genes_df[["Freq"]],
                                        decreasing = TRUE),
                                        length(ID))
...
# Create data rame with row means of expression and CNA values
...
```{r, echo=FALSE, fig.cap="Genes with frequent and highly significant somatic genetic changes in HNSCC", fig.align = 'center', out.width='100%'}
...
Looking on the precision it can be said that our logistic regression model for prediction of deleterious mutation in head and neck cancer scores very poorly. To be just in about 0,3% of all cases precise with the prediction is an unusuable model and has plenty of room for improvement. Especially regarding to declining precision towards a recall of 1.00, which is a true mutation and a result on which basis further decisions would be drawn.
<br/><br/>
...
```{r 4_cleanup}
rm(precision, prediction, recall, regression.genes, threshhold_ls, inTrain,
