...
```{r}
'Daisy.Spearman' <- function(input_genes,input_data){
...
SL.partner[[2]] = reduce.partner(SL.partner, 2, 0.8)
SL.partner[[3]] = reduce.partner(SL.partner, 3, 0.8)
SL.partner[[5]] = reduce.partner(SL.partner, 5, 0.6)
lapply(1:length(SL.partner), function(a){nrow(SL.partner[[a]])})
```
