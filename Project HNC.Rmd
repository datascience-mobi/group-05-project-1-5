...
```{r}
mutation.HNC.bind = do.call(rbind, mutation.HNC) #all mutation data of HNC samples in one dataframe

heatmap.genes = as.data.frame(table(mutation.HNC.bind$Hugo_Symbol)) #dataframe with all mutated genes in HNC samples
