...
![Figure 1 | Most affected tissues and organs by head and neck cancer](images/HNC_Kopf.png)
...
![Figure 2 | Daisy-System](images/Daisy.png)
...
## Milestones
![Figure 3 | Milestones of our project](images/milestones.png)
...
```{r}
ID_HNC_highest_frequencies = head(order(HNC_mutated_genes_df[["Freq"]], decreasing = TRUE), length(ID_HNC_highest_frequencies))  
HNC_mutated_genes_df_highest_ordered = HNC_mutated_genes_df[ID_HNC_highest_frequencies, ]
rownames(HNC_mutated_genes_df_highest_ordered) = 1:length(ID_HNC_highest_frequencies)
