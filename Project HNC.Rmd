...
all_mutations = do.call(rbind, allDepMapData$mutation)
...
all_mut_plot = ggplot(data = all_mutated_genes_df_highest_30_ordered, aes(x=Gene, y=Freq))  
...
HNC_mut_plot = ggplot(data = HNC_mutated_genes_df_highest_ordered, aes(x=Gene, y=Freq)) 
  +     geom_bar(stat = "identity", width = 0.5, fill="steelblue") 
  +     geom_text(aes(label=Freq), vjust=-0.3, size=3.5) 
  +     theme_minimal()
HNC_mut_plot
