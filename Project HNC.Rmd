...
```{r}
SL.partner.reduced = reduce.partner(SL.partner, "...") # enter gene which wants to be kept
SDL.partner.reduced = reduce.partner(SDL.partner, "...") # enter gene which wants to be kept
data.frame("SL genes" = names(SL.partner),
