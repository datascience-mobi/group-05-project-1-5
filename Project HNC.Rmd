...
```{r 3_SL_network, fig.height = 7, fig.width = 14}
network(SL.partner,2,"grey","black",8.1,"Network of SL interaction", NA, goi.SL )
```

Creating a network for the SDL-partner
```{r 3_SDL_network, fig.height = 7, fig.width = 14}
network(SDL.partner,2,"grey","black",8.1,"Network of SDL interaction", NA, goi.SDL )
```
