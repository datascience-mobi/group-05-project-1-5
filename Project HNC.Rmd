...
### Cleanup of the enviroment
```{r}
rm(kd.ceres.HNC.dist, kd.ceres.reference, kd.ceres.reference.dist, mean.kd.ceres, mean.kd.ceres.reference, esgene1, esgeneT)
```
...
goi.sdl = comb.ex.cna[which(comb.ex.cna$y_kmeans == 3),]
...
names(SL.functional.examination) = goi.SL
```
### Gene coexpression
...
```
Reduce SL.parter the most significant
```{r}
